...
class CarControllerTest {
    ...
    public void testAddCar() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/cars")
                ...
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.id").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.model").value("Polo"));
    ...
    public void editCar() throws Exception {
        ...
        CarRequest carToEdit = new CarRequest("Ford", "Focus", 400, 10);
        ...
        assertEquals(10, editedCarFromDB.getBestDiscount());
    }
